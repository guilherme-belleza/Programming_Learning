...
#Para cada posição na faixa de 0 até numero total da tupla "len(tabela)"
for posiçao in range(0, len(tabela)):


    # Condição para verificar os 1 iten se é PAR)
    # No caso da Tupla acima os nomes das carnes são 0 = picanha, 2 = contra file.... 
    # então são os pares da tupla
    if posiçao % 2 == 0:  
